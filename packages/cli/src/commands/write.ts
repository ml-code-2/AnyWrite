...
import { PipelineRunner, StateManager } from "@actalk/anywrite-core";
  ...
  .action(async (args: ReadonlyArray<string>, opts) => {
    try {
      ...
      if (args.length === 1) {
        ...
        throw new Error("Usage: anywrite write rewrite [book-id] <chapter>");
      }
  ...
  .action(async (args: ReadonlyArray<string>, opts) => {
    try {
      ...
      if (args.length === 1) {
        ...
        throw new Error("Usage: anywrite write sync [book-id] <chapter>");
      }
  ...
  .action(async (args: ReadonlyArray<string>, opts) => {
    try {
      ...
      if (args.length === 1) {
        ...
        throw new Error("Usage: anywrite write repair-state [book-id] <chapter>");
      }
